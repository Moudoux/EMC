...
public class IFont {
	...
	public IFont(Font font, boolean antiAlias, int charOffset) {
		this.font = font;
	...
	public IFont(Font font, boolean antiAlias) {
		this.font = font;
		this.antiAlias = antiAlias;
		charOffset = 8;
		setupTexture(antiAlias);
	...
	private void drawQuad(float x, float y, float width, float height, float srcX,
						  float srcY, float srcWidth, float srcHeight) {
		float renderSRCX = srcX / IMAGE_WIDTH, renderSRCY = srcY / IMAGE_HEIGHT,
