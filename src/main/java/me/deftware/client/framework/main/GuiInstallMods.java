...
public class GuiInstallMods extends Screen {
    ...
    public GuiInstallMods(JsonArray mods) {
        super(new StringTextComponent("Installing mods"));
        this.mods = mods;
        it = mods.iterator();
        iterate();
    }
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        renderBackground();
        drawCenteredString(font, "Installing EMC mods...", width / 2, 21, 16777215);
        if (!done) {
            drawCenteredString(font, status, width / 2, 60, 16777215);
            drawCenteredString(font, subStatus, width / 2, 70, 16777215);
        } else {
            drawCenteredString(font, "Please restart Minecraft", width / 2, 60, 16777215);
            /*
