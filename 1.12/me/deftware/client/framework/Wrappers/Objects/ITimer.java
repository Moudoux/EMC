...
public class ITimer extends Timer {
	...
	/**
	 * 
	 * public float getTimerSpeed() { return this.timerSpeed; }
	 * 
	 * public void setTimerSpeed(float speed) { this.timerSpeed = speed; }
	 * 
	 * public static float getMinecraftTimerSpeed() { return
	 * Minecraft.getMinecraft().timer.timerSpeed; }
	 * 
